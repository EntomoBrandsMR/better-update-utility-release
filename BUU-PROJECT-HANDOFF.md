...
- **BUU 2.0** — branch `v2.0.0-elastic`, `version-buu2.json` channel, productName "BUU 2.0", appId `com.entomobands.buu-2`, userData `%APPDATA%\buu-2`. **Active branch. All current feature work targets this.** Currently shipped: **v2.2.2**. Next release in design: **v2.3.0**.
...
### 0.2 BUU 2.0 — what's shipped (v2.0.0 → v2.2.2)
